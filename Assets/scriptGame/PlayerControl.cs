...
public class PlayerControl : MonoBehaviour
{
	...
	private Transform groundCheck2;			// A position marking where to check if the player is grounded if flipped back.
	public bool grounded1 = false;			// Whether or not the player is grounded.
	public bool grounded2 = false;			// Whether or not the player is grounded.
